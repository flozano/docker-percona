...
-e MYSQL_MYSQLD_BINLOG_FORMAT=ROW \
-e MYSQL_MYSQLD_LARGE_PAGES \
-e MYSQL_MYSQLD_SKIP_NAME_RESOLVE \
-e MYSQL_MYSQLD_SKIP_HOST_CACHE \
-e MYSQL_MYSQLD_SKIP_EXTERNAL_LOCKING \
-e MYSQL_MYSQLD_SKIP_INNODB_DOUBLEWRITE \
